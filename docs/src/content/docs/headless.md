...
- `non_terminal_tasks`: move, complete, manually move, or delete dependent Tasks, then retry.
- `executable_current_nodes`: stop execution and resolve affected Tasks, then retry.
