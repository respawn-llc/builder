...
- Background process IDs are unique for one server lifetime. Their Session association controls Project list membership, notices, and history. Direct process access and controls use the process ID without revalidating Project membership.
