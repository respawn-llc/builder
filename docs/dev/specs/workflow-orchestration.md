...
- If an initiating action loses its durable execution-target negotiation fence, it returns a typed conflict outcome. Clients refetch the task state before another initiating action and never reuse the superseded negotiation generation.
