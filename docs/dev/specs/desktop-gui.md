...
- Desktop acknowledges Task Start after durable placement without waiting for preparation. Preparation failure uses the existing interrupted-Current-Node error display and Resume action.
