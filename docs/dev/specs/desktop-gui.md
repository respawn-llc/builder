...
- The top Task Detail action opens or focuses the highest-priority unresolved attention. Every unresolved item not awaiting an answer result has inline controls.
