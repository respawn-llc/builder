...
- The spinner appears for runtime work except while a Question waits for the user, for compaction, or while the server's live Reviewer activity is `running`.
