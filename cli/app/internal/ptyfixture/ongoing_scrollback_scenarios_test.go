	...
	for _, tc := range []struct {
		...
		},
		{
			...
			expectedStyledAppends: []styledAppendExpectation{
				...
				{Text: "• PTY_TOOL_IMAGE", Foreground: colorForStyle(transcriptrender.StyleRoleTool), Faint: true},
				{Text: "? PTY_TOOL_QUESTION", Foreground: colorForStyle(transcriptrender.StyleRoleToolQuestion), Faint: true},
				{Text: "@ PTY_TOOL_WEB", Foreground: colorForStyle(transcriptrender.StyleRoleToolWebSearch), Faint: true},
				{Text: "• PTY_TOOL_CUSTOM", Foreground: colorForStyle(transcriptrender.StyleRoleTool), Faint: true},
				{Text: "• PTY_TOOL_COMPLETE", Foreground: colorForStyle(transcriptrender.StyleRoleTool), Faint: true},
				{Text: "• PTY_TOOL_HANDOFF", Foreground: colorForStyle(transcriptrender.StyleRoleTool), Faint: true},
