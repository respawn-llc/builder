...
func TestEmbeddedAppServerDeliversBackgroundCompletionWhileIdle(t *testing.T) {
	...
	plan, runtimePlan := prepareAppRuntimePlan(t, server, sessionLaunchRequest{Mode: launchModeInteractive, Intent: serverapi.CreateNewSessionLaunchIntent(nil)}, io.Discard, "test background completion while idle")
...
func TestPrepareRuntimeForwardsBackgroundCompletionIntoProjectedRuntimeEvents(t *testing.T) {
	...
	plan, runtimePlan := prepareAppRuntimePlan(t, server, sessionLaunchRequest{Mode: launchModeInteractive, Intent: serverapi.CreateNewSessionLaunchIntent(nil)}, io.Discard, "test projected background completion while idle")
	defer runtimePlan.Close()
...
func TestEmbeddedAppServerPrepareRuntimeWiresProcessControlForUIActions(t *testing.T) {
	...
	_, runtimePlan := prepareAppRuntimePlan(t, server, sessionLaunchRequest{Mode: launchModeInteractive, Intent: serverapi.CreateNewSessionLaunchIntent(nil)}, io.Discard, "test prepare runtime process control")
	defer runtimePlan.Close()
...
func TestEmbeddedAppServerPrepareRuntimeWiresProcessOutputClient(t *testing.T) {
	...
	_, runtimePlan := prepareAppRuntimePlan(t, server, sessionLaunchRequest{Mode: launchModeInteractive, Intent: serverapi.CreateNewSessionLaunchIntent(nil)}, io.Discard, "test prepare runtime process output")
	defer runtimePlan.Close()
...
func TestEmbeddedAppServerPromptActivityStreamsAndHydratesPendingResources(t *testing.T) {
	...
	plan, runtimePlan := prepareAppRuntimePlan(t, server, sessionLaunchRequest{Mode: launchModeInteractive, Intent: serverapi.CreateNewSessionLaunchIntent(nil)}, io.Discard, "test embedded prompt activity parity")
	defer runtimePlan.Close()
...
func TestEmbeddedAppServerPendingPromptsKeepPromptActivityForAnsweringOnly(t *testing.T) {
	...
	plan, runtimePlan := prepareAppRuntimePlan(t, server, sessionLaunchRequest{Mode: launchModeInteractive, Intent: serverapi.CreateNewSessionLaunchIntent(nil)}, io.Discard, "test embedded ask notification")
	defer runtimePlan.Close()
