...
func TestWorkflowTaskAndCommentRequestValidation(t *testing.T) {
	...
	testValidWorkflowRequests(t, []workflowValidRequestCase{
		...
		{name: "task approve", request: WorkflowTaskApproveRequest{ApprovalID: "018fdd67-89ab-4cde-8123-456789abc001"}},
		...
		{name: "user completion by task", request: WorkflowTaskCompleteRequest{ActorKind: WorkflowTaskCompleteActorUser, Force: true, TaskID: "task-1"}},
	...
	testWorkflowFieldErrors(t, []workflowFieldErrorCase{
		...
		{name: "task approve requires approval", request: WorkflowTaskApproveRequest{}, field: "approval_id", code: WorkflowRequestErrorRequired},
		...
		{name: "user completion requires force", request: WorkflowTaskCompleteRequest{ActorKind: WorkflowTaskCompleteActorUser, TaskID: "task-1"}, field: "force", code: WorkflowRequestErrorInvalidMode},
		...
		{name: "user completion rejects multiple selectors", request: WorkflowTaskCompleteRequest{ActorKind: WorkflowTaskCompleteActorUser, Force: true, TaskID: "task-1", SessionID: "session-1"}, field: "selector", code: WorkflowRequestErrorInvalidMode},
