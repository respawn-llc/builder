...
var routeContracts = []Route{
	...
	unary[serverapi.WorkflowTaskStartRequest, serverapi.WorkflowTaskInitiatingActionResult](protocol.MethodWorkflowTaskStart, AuthServer, ScopeProjectView, ConnectionUnscoped, DependencyWorkflow),
	...
	unary[serverapi.WorkflowTaskApproveRequest, serverapi.WorkflowTaskInitiatingActionResult](protocol.MethodWorkflowTaskApprove, AuthServer, ScopeProjectView, ConnectionUnscoped, DependencyWorkflow),
	unary[serverapi.WorkflowTaskMoveRequest, serverapi.WorkflowTaskInitiatingActionResult](protocol.MethodWorkflowTaskMove, AuthServer, ScopeProjectView, ConnectionUnscoped, DependencyWorkflow),
