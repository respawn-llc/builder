...
var routeContracts = []Route{
	...
	dedicatedUnary[serverapi.WorkflowTaskObservationRequest, serverapi.WorkflowTaskObservationResponse](protocol.MethodWorkflowTaskObserve, "workflow-task-observe", ScopeProjectView, DependencyWorkflow),
	...
	dedicatedUnary[serverapi.RuntimeLiveWatchRequest, serverapi.RuntimeLiveWatchResponse](protocol.MethodRuntimeLiveWatch, "runtime-live-watch", ScopeRuntimeLiveSessionRequired, DependencyRuntimeControl),
