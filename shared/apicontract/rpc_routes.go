...
var routeContracts = []Route{
	...
	dedicatedUnary[serverapi.UpdateStatusRequest, serverapi.UpdateStatusResponse](protocol.MethodServerUpdateStatusGet, "get-update-status", ScopeNone, DependencyServerStatus),
