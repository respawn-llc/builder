...
var routeContracts = []Route{
	...
	unary[serverapi.WorktreeDeleteOperationRequest, serverapi.WorktreeDeleteResult](protocol.MethodWorktreeDelete, AuthServer, ScopeSessionActiveProject, ConnectionControl, DependencyWorktree),
