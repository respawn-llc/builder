...
func TestWorkflowDefinitionExhaustiveMessageFields(t *testing.T) {
	expected := map[protoreflect.Name][]protoreflect.Name{
		...
		"ValidateScriptPathError":           {"code", "invalid_request", "workflow_not_found", "internal_failure"},
		...
		"ValidateScriptPathResult":          {"success", "error"},
		...
		"WorkflowSubscriptionStartError":    {"code", "invalid_request", "workflow_not_found", "internal_failure"},
		"ProjectSubscriptionStartError":     {"code", "invalid_request", "workflow_not_found", "internal_failure"},
...
func TestWorkflowDefinitionExhaustiveMessageOneofs(t *testing.T) {
	expected := map[protoreflect.Name]map[protoreflect.Name][]protoreflect.Name{
		...
		"ValidateScriptPathError":         {"detail": {"invalid_request", "workflow_not_found", "internal_failure"}},
		...
		"ValidateScriptPathResult":        {"outcome": {"success", "error"}},
		...
		"WorkflowSubscriptionStartError":  {"detail": {"invalid_request", "workflow_not_found", "internal_failure"}},
		"ProjectSubscriptionStartError":   {"detail": {"invalid_request", "workflow_not_found", "internal_failure"}},
