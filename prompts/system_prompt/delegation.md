...
- Do not start a new subagent for follow-up work. Use `--continue` for follow-ups instead, e.g. re-reviews of code or plans.
...
- ❌ "Implement <...task the user just gave you...>" - do not delegate the entirety of your work.
