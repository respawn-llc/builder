...
func TestBoardAndTaskDetailUseDurableWorkflowMetadataOnly(t *testing.T) {
	...
	board, err := view.board(t).Get(ctx, workflowViewUnfilteredBoardRequest(binding.ProjectID))
	if err != nil {
	...
	donePage, err := view.board(t).ListNodeCards(ctx, workflowViewUnfilteredBoardNodeCardsRequest(binding.ProjectID, string(workflowID), doneColumn.Node.NodeID))
	if err != nil {
...
func TestBoardAndTaskDetailProjectTaskSourceWorkspaceAndBody(t *testing.T) {
	...
	backlogPage, err := view.board(t).ListNodeCards(ctx, workflowViewUnfilteredBoardNodeCardsRequest(binding.ProjectID, string(workflowID), backlogColumn.Node.NodeID))
	if err != nil {
...
func TestBoardProjectsCurrentWorkspaceFactsAndDetachedHistoricalSource(t *testing.T) {
	...
	oneWorkspaceBoard, err := view.board(t).Get(ctx, workflowViewUnfilteredBoardRequest(binding.ProjectID))
	if err != nil {
...
func TestBoardAndTaskDetailProjectParallelBranchPlacements(t *testing.T) {
	...
	branchPage, err := view.board(t).ListNodeCards(ctx, workflowViewUnfilteredBoardNodeCardsRequest(binding.ProjectID, string(workflowID), branchColumn.Node.NodeID))
	if err != nil {
...
func workflowViewUnfilteredBoardRequest(projectID string) serverapi.WorkflowBoardRequest {
	return serverapi.WorkflowBoardRequest{
		ProjectID:   projectID,
		LabelFilter: serverapi.WorkflowTaskLabelFilterNone(),
	}
}

func workflowViewUnfilteredBoardNodeCardsRequest(
	projectID string,
	workflowID string,
	nodeID string,
