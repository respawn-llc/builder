...
var allowedSmallPackages = map[string]string{
	...
	"internal/testharness/openairesponses": "test-only OpenAI Responses HTTP fixture shared by runtime wiring and workflow runner integration tests without production client seams",
