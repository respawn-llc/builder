...
var allowedSmallPackages = map[string]string{
	...
	"server/workflowattention":           "workflow approval notification finalizer boundary kept separate so workflowstore returns committed facts while service/runtime share one flusher",
