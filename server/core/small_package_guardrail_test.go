...
var allowedSmallPackages = map[string]string{
	...
	"server/capabilityfacts":             "aggregate capability-facts service package reserved for the server projection owner introduced by KENT-188",
	...
	"server/onboardingimports":           "canonical onboarding import discovery domain shared by capability facts and future finalize services",
	...
	"server/skillcatalog":                "canonical Kent skill discovery owner shared by runtime and capability/import facts without making runtime own read-only catalog projection",
