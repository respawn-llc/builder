...
var allowedSmallPackages = map[string]string{
	...
	"cli/app/internal/connectionstate":            "interactive-lifecycle connection owner and classifier shared by auth, picker, and main UI without surface-specific state machines",
	...
	"cli/app/internal/runtimeattach":              "legacy runtime attachment compatibility seam pending its separately scoped removal; remains distinct from interactive connection ownership",
	...
	"cli/app/internal/startupremote":              "configured remote startup validator shared by initial attachment and validated successor replacement",
