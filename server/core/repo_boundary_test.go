...
func TestSharedClientUIRemainsDTOOnly(t *testing.T) {
	...
	allowedFuncs := map[string]struct{}{
		...
		"decodeOperationalDiagnosticPayload":                      {},
		"decodeStrictTranscriptPayload":                           {},
		...
		"TranscriptProviderStateDiagnostic.transcriptEventKind":   {},
		...
		"TranscriptProviderStateDiagnostic.Validate":              {},
