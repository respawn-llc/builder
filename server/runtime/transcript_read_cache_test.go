...
func TestRecentTailTranscriptWindowCacheReflectsLiveStreamingOnHit(t *testing.T) {
	...
	newTranscriptPersistenceCoordinator(eng.transcriptRuntimeState()).AppendStreamingDelta("step-1", eng.TranscriptRevision(), eng.CommittedTranscriptEntryCount(), "partial answer")
