...
type RuntimeWiringOptions struct {
	...
	LifecycleTaskOwner                  runtime.LifecycleTaskOwner
	OrderedMutation                     func(func(runtime.OrderedMutationTurn) error) error
...
func NewRuntimeWiringWithBackground(
	...
	eng, err = runtime.New(store, eventLog, client, toolRegistry, runtime.Config{
		...
		LifecycleTaskOwner:    opts.LifecycleTaskOwner,
		OrderedMutation:       opts.OrderedMutation,
	})
	if err != nil {
		return nil, err
	}
