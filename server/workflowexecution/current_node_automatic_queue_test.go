...
func TestCurrentNodeAutomaticQueueSelectionPreservesTaskLocalityAndFIFO(t *testing.T) {
	...
	entries := []currentNodeQueuedStart{
		{reference: workflow.CurrentNodeReference{TaskID: taskOne, NodeID: "agent-one"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticAgent},
		{reference: workflow.CurrentNodeReference{TaskID: taskTwo, NodeID: "script-two"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticScript},
		{reference: workflow.CurrentNodeReference{TaskID: taskOne, NodeID: "script-one"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticScript},
		{reference: workflow.CurrentNodeReference{TaskID: taskTwo, NodeID: "agent-two"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticAgent},
	}
...
func TestCurrentNodeAutomaticQueueRemovalMaintainsEveryIndex(t *testing.T) {
	queue := currentNodeAutomaticQueue{}
	entries := []currentNodeQueuedStart{
		{reference: workflow.CurrentNodeReference{TaskID: "task-a", NodeID: "agent-a"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticAgent},
		{reference: workflow.CurrentNodeReference{TaskID: "task-a", NodeID: "script-a"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticScript},
		{reference: workflow.CurrentNodeReference{TaskID: "task-b", NodeID: "agent-b"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticAgent},
		{reference: workflow.CurrentNodeReference{TaskID: "task-b", NodeID: "script-b"}, launchPreparation: LaunchPreparation{Kind: LaunchPreparationEstablishedRoot}, policy: currentNodeAdmissionAutomaticScript},
	}
	for _, entry := range entries {
		queue.append(entry)
	}
