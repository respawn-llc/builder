...
CREATE TEMP TABLE migration_transition_group_fk_check_zero(value INTEGER NOT NULL CHECK (value = 0));

INSERT INTO migration_transition_group_fk_check_zero(value)
SELECT 1
WHERE EXISTS (
    SELECT 1
...
DROP TABLE migration_transition_group_fk_check_zero;
