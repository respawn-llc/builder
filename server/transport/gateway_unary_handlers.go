...
var gatewayUnaryHandlerEntries = map[string]gatewayUnaryHandler{
	...
	protocol.MethodWorkflowTaskStart:             gatewayClientCall[client.WorkflowClient, serverapi.WorkflowTaskStartRequest, serverapi.WorkflowTaskInitiatingActionResult](GatewayDependencies.WorkflowClient, client.WorkflowClient.StartWorkflowTask),
	...
	protocol.MethodWorkflowTaskApprove:           gatewayClientCall[client.WorkflowClient, serverapi.WorkflowTaskApproveRequest, serverapi.WorkflowTaskInitiatingActionResult](GatewayDependencies.WorkflowClient, client.WorkflowClient.ApproveWorkflowTask),
	protocol.MethodWorkflowTaskMove:              gatewayClientCall[client.WorkflowClient, serverapi.WorkflowTaskMoveRequest, serverapi.WorkflowTaskInitiatingActionResult](GatewayDependencies.WorkflowClient, client.WorkflowClient.MoveWorkflowTask),
