...
var gatewayUnaryHandlerEntries = map[string]gatewayUnaryHandler{
	...
	protocol.MethodWorkflowProjectLabelReorder:   gatewayClientCall[apicontract.WorkflowService, serverapi.WorkflowProjectLabelReorderRequest, serverapi.WorkflowProjectLabelCatalogResponse](GatewayDependencies.WorkflowClient, apicontract.WorkflowService.ReorderWorkflowProjectLabels),
	...
	protocol.MethodSessionGetExecutionEnvironment:                gatewayClientCall[apicontract.SessionViewService, serverapi.SessionExecutionEnvironmentRequest, serverapi.SessionExecutionEnvironmentResponse](GatewayDependencies.SessionViewClient, apicontract.SessionViewService.GetSessionExecutionEnvironment),
