...
var gatewayUnaryHandlerEntries = map[string]gatewayUnaryHandler{
	...
	protocol.MethodSessionPage:                   gatewayClientCall[client.ProjectViewClient, serverapi.SessionPageRequest, serverapi.SessionPageResponse](GatewayDependencies.ProjectViewClient, client.ProjectViewClient.ListSessionPage),
	...
	protocol.MethodWorktreeWorkspaceList:                         gatewayClientCall[client.WorktreeClient, serverapi.WorktreeWorkspaceListRequest, serverapi.WorktreeWorkspaceListResponse](GatewayDependencies.WorktreeClient, client.WorktreeClient.ListWorkspaceWorktrees),
