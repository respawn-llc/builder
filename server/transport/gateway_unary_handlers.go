...
var gatewayUnaryHandlerEntries = map[string]gatewayUnaryHandler{
	...
	protocol.MethodSessionGetCommittedTranscriptSuffix: gatewayClientCall[client.SessionViewClient, serverapi.SessionCommittedTranscriptSuffixRequest, serverapi.SessionCommittedTranscriptSuffixResponse](GatewayDependencies.SessionViewClient, client.SessionViewClient.GetSessionCommittedTranscriptSuffix),
