...
export function BoardHoverMenu({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-[var(--board-menu-padding)] left-[var(--board-menu-padding)] flex h-10 shrink-0 items-center gap-[var(--board-menu-icon-gap)]"
        data-testid="board-hover-menu-actions"
      >
