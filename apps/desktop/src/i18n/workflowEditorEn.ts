export const workflowEditorEnglish = {
  ...
  executionPolicyNone: "None",
  executionPolicyHead: "HEAD",
  executionPolicyDefaultBranch: "Default branch",
  executionPolicyCustomRef: "Custom ref",
  executionPolicyAsk: "Ask every time",
  executionPolicyHelp:
    "Choose the task execution target. Kent locks the selected target when automation starts.",
  customRef: "Custom ref",
  customRefHelp: "A Git ref Kent resolves when task automation starts.",
