...
export const englishResources = {
  translation: {
    ...
    labels: {
      ...
      deleteBody: "This removes the label from every task.",
      confirmDelete: "Delete label",
      invalidName: "Use 1–64 letters, numbers, spaces, hyphens, underscores, or slashes.",
    ...
    board: {
      ...
      moveRunInterruptedBody:
        "A run for task {{taskID}} stopped after the move. Open the task for details or resume it.",
      deleteTask: "Delete",
    ...
    executionTargetContinuation: {
      ...
      continue: "Continue",
      resolving: "Resolving target and preparing the workspace…",
      failed: "Could not prepare the execution target",
