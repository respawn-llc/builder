  ...
  translation: {
    app: {
      ...
      attention: {
        ...
        interruptedRunTitle: "Run interrupted",
        questionFallback: "question from agent",
        approvalFallback: "action required",
        interruptedRunFallback: "run interrupted",
    ...
    board: {
      ...
      moveRunInterruptedBody: "A run for task {{taskID}} stopped after the move. Open the task for details or resume it.",
      deleteTask: "Delete",
    ...
    task: {
      ...
      executionTargetDialogTitle: "Choose execution target",
      executionTargetDialogBody:
        "Kent will lock this target for the task before continuing the requested workflow action.",
      executionTargetContinue: "Continue",
      executionTargetNone: "None",
      executionTargetHead: "HEAD",
      executionTargetDefaultBranch: "Default branch",
      executionTargetCustomRef: "Custom ref",
      executionRoot: "Execution root",
      executionTargetSourceRef: "Source ref",
      executionTargetCommit: "Resolved commit",
      executionTargetRequestedRef: "Requested ref",
      executionTargetValueCopied: "{{label}} copied",
      executionTargetValueCopyFailed: "Could not copy {{label}}",
