...
export const englishResources = {
  translation: {
    ...
    taskDependencyConfirmation: {
      title: "Start task ahead of dependencies?",
      body: "The task still has {{count}} unsatisfied dependencies, do you still want to start it?",
      view: "View deps",
      start: "Start",
    },
    ...
    task: {
      ...
      dependenciesProgress: "Dependencies: {{completed}} of {{total}} complete.",
